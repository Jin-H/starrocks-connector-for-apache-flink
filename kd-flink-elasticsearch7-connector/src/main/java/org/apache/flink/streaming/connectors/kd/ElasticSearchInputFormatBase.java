...
/**
 * Base class for all Flink Elasticsearch Sources. This class implements the common behaviour across
...
public class ElasticSearchInputFormatBase<T, C extends AutoCloseable>
    ...
    public void configure(Configuration parameters) {
        // because of createInputSplits(it needs use client) running before openInputFormat, so we
        // cannot create client in openInputFormat
        try {
