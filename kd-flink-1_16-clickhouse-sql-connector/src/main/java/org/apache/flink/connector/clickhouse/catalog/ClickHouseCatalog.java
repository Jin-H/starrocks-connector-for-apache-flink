...
public class ClickHouseCatalog extends AbstractCatalog {
    ...
    public void open() throws CatalogException {
        try {
            ...
            ClickHouseDataSource dataSource = new ClickHouseDataSource(jdbcUrl, configuration);
    ...
    public synchronized TableSchema createTableSchema(String databaseName, String tableName) {
