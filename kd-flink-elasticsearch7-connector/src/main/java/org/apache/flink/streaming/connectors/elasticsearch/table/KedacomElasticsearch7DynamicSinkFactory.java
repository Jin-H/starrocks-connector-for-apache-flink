...
import org.apache.flink.streaming.connectors.elasticsearch.table.KedacomElasticsearch7Options.SinkModeType;
...
/**
 * A {@link DynamicTableSinkFactory} for discovering {@link KedacomElasticsearch7DynamicSink}.
 */
@Internal
public class KedacomElasticsearch7DynamicSinkFactory implements DynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new KedacomElasticsearch7DynamicSink(
